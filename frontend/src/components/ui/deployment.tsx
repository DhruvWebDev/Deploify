      ...
      <div className="grid gap-8">
        ...
        <Card className="w-full">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Select a repository, framework, and set environment variables to deploy it.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <Button onClick={() => window.location.href = "https://github.com/apps/deploify"}>
              ...
              <div className="space-y-2">
                ...
                <Select value={framework} onValueChange={(value) => setFramework(value as SupportedFramework)}>
                  <SelectTrigger>
            ...
            <CardContent>
              <ScrollArea className="h-[300px] rounded-md border">
                <div className="p-4 space-y-4">
                  <pre className="whitespace-pre-wrap font-mono text-sm">{deployLogs}</pre>
                </div>
              </ScrollArea>
            </CardContent>
          </Card>
